...
\newcommand{\hmwkTitle}{Ανάπτυξη Εφαρμογής Android για την Εύρεση και Απεικόνιση Γεωγραφικών Δεδομένων\\με συγχρονές τεχνολογίες web} % Assignment title
\newcommand{\hmwkType}{Πτυχιακή Εργασία}
\newcommand{\hmwkAuthorName}{Ορέστης\ Μ.\ Κτενάς\ [Π03078]} % Author name 
\newcommand{\hmwkAuthorEmail}{orestiskt@gmail.com} % Author email
\newcommand{\hmwkSupervisor}{Μαρία Βίρβου} % Supervisor

\author{\normalsize\textbf{\hmwkAuthorName}\\ \normalsize\textcolor{LightGray}{\hmwkAuthorEmail}}
\date{\normalsize{Πειραιάς\ 2014}} % Insert date here if you want it to appear below author's name
...
\include{chapter2-android_platform}
\include{chapter3-app_overview}
\include{chapter4-app}
\include{chapter5-server}
